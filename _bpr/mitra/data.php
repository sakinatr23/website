<?php include_once('../_header.php'); ?>
	...
	<div class="box">
		<h1>Data Penerima Dana Bantuan</h1>
			<h4>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-hover" id="datatables"> 
					...
					$query = "SELECT * FROM tb_mitra
							  INNER JOIN tb_kecamatan ON tb_mitra.id_kecamatan = tb_kecamatan.id_kecamatan
					";
					$sql_mitra = mysqli_query($con, $query) or die (mysqli_error($con));
						...
						while ($data = mysqli_fetch_object($sql_mitra)) 
	                        ...
	                        <td><?php echo " $data->jenis_usaha"; ?></td>
	                 		<!-- <td class="text-center">
	                 				<a href="edit.php?id=<?php echo $data->id_mitra; ?>" class="btn-warning btn-xs"><i class="glyphicon glyphicon-edit"></i></a>
									<a href="del.php?id=<?php echo $data->id_mitra; ?>" onclick="return confirm('Yakin akan Dihapus?')" class="btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
	                 		</td> -->
							</tr>
